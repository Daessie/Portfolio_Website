    ...
    <section id="home" className="hero">
      <div className="hero-content">
        ...
        <div className="hero-image">
          <div className={`glass-card hero-card ${darkMode ? 'dark-mode' : ''}`}>
            <div className="hero-avatar">
              {/* Replace with your photo/avatar */}
            ...
            <div className="hero-details">
              <div className="detail-item">
                ...
                <span className="detail-value">React & UI/UX</span>
              </div>
            </div>
          </div>
        </div>
...
// export default Hero;<div><span className="detail-label">Experience</span>
//                 <span className="detail-value">5+ Years</span>
//               </div>
//               <div className="detail-item">
//                 <span className="detail-label">Projects</span>
//                 <span className="detail-value">40+ Completed</span>
//               </div>
//               <div className="detail-item">